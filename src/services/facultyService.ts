    ...
    programs: [
      {
        ...
        studyPlan: [],
        slug: generateSlug('Ingeniería Agrónoma'),
        icon: 'Agriculture',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería Mecánica'),
        icon: 'Build',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería Civil'),
        icon: 'Architecture',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería Eléctrica'),
        icon: 'FlashOn',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería Industrial'),
        icon: 'Factory',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería Química'),
        icon: 'Science',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Ingeniería de Sistemas'),
        icon: 'Computer',
      },
    ],
    ...
    programs: [
      {
        ...
        studyPlan: [],
        slug: generateSlug('Artes Audiovisuales'),
        icon: 'Videocam',
      },
      {
      ...
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Música'),
        icon: 'MusicNote',
      },
      {
        name: 'Diseño Gráfico',
        slogan: 'Visualizando ideas, comunicando la esencia del Llano con creatividad.',
        description: 'Formamos diseñadores gráficos con una sólida base en comunicación visual, creatividad y tecnología. El programa abarca áreas como branding, diseño editorial, ilustración, diseño web y multimedia. Los estudiantes aprenderán a conceptualizar y producir soluciones gráficas innovadoras para diversas plataformas y audiencias, con un enfoque en la identidad cultural y las necesidades de la región.',
        uniqueFocus: 'Diseño para el Desarrollo Regional, creando identidades visuales para emprendimientos locales, campañas de concientización social y proyectos culturales que promuevan la riqueza del Arauca.',
        graduateProfile: 'Será un diseñador gráfico versátil, capaz de trabajar en agencias de publicidad, estudios de diseño, medios de comunicación, instituciones culturales o como profesional independiente, aportando soluciones creativas y estratégicas.',
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Diseño Gráfico'),
        icon: 'Palette',
      },
      {
        name: 'Diseño UI/UX',
        slogan: 'Creando experiencias digitales intuitivas y estéticas para el mundo llanero.',
        description: 'Formamos diseñadores capaces de crear interfaces de usuario (UI) y experiencias de usuario (UX) centradas en las necesidades de las personas. El programa combina principios de diseño gráfico, interacción humana-computadora, investigación de usuarios y prototipado. Los estudiantes aprenderán a diseñar soluciones digitales para aplicaciones móviles, sitios web y sistemas interactivos, con un enfoque en la accesibilidad y la usabilidad.',
        uniqueFocus: 'Diseño de Experiencias Digitales para el Sector Agropecuario y Turístico del Llano, desarrollando plataformas y aplicaciones que faciliten la gestión de fincas, la comercialización de productos locales y la promoción del ecoturismo en la región.',
        graduateProfile: 'Será un diseñador UI/UX con habilidades para investigar, idear, prototipar y evaluar soluciones digitales, capaz de trabajar en equipos multidisciplinarios y liderar proyectos de innovación tecnológica con impacto social.',
        duration: '8 semestres',
        studyPlan: [],
  ...
  },
  {
    ...
    programs: [
      ...
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Bacteriología'),
        icon: 'Biotech',
      },
      {
        ...
        duration: '10 semestres',
        studyPlan: [],
        slug: generateSlug('Medicina Veterinaria y Zootecnia'),
        icon: 'Pets',
      },
    ],
    emblematicProjects: [
  ...
  },
  {
    ...
    programs: [
      ...
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Ciencias Políticas'),
        icon: 'Public',
      },
      {
        name: 'Periodismo',
        ...
        graduateProfile: 'Será un comunicador social y periodista con habilidades para la investigación, la producción de contenidos multimedia y la gestión de proyectos de comunicación para el desarrollo y la paz.',
        duration: '8 semestres',
        studyPlan: [],
      ...
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Antropología'),
        icon: 'Diversity3',
      },
      {
        name: 'Historia',
    ...
    programs: [
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Licenciatura en Ciencias Naturales'),
        icon: 'Nature',
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Licenciatura en Matemáticas'),
        icon: 'Calculate',
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Licenciatura en Lengua Castellana'),
        icon: 'MenuBook',
      },
      {
        ...
        duration: '8 semestres',
        studyPlan: [],
        slug: generateSlug('Licenciatura en Ciencias Sociales'),
        icon: 'Groups',
      },
    ],
    emblematicProjects: [
